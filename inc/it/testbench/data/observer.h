...
class Subject {
    public:
         ...
         */
        void addObserver(const Observer* obs);          //!< basic behaviour: add an observer
        /**
...
class Observer {
    public:
         ...
         */
        const string* getWhoAmI();                      /*!< observe identifier */
        /**
          * Set the indentifier choose for this observer
          *
          * @param[in] Pointer to a string containing the identifier.
         */
        void getWhoAmI(const string* identifier);       /*!< observe identifier */
